 ...
 * -----
 *
 * spadescarleton.action.php
 *
 * SpadesCarleton main action entry point
 *
 *
 ...
 */
class action_spadescarleton extends APP_GameAction
{
    /**
    ...
    public function __default()
    {
        ...
        {
            $this->view = "spadescarleton_spadescarleton";
